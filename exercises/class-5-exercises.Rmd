...
It is not necessarily a good decision, as the model lacks an important variable: Watering. The soil moisture might be a super stable variable *across* air temperatures because of preventive watering. So without this variable, we will have a hard time making decisions.
...
```{r}
dag5M.1 <- dagitty( "dag{ SM -> MH; MH <- FI -> SM; FI -> SM }" )
coordinates(dag5M.1) <- list( x=c(SM=0, FI=2, MH=1) , y=c(SM=1,FI=1,MH=0) )
drawdag( dag5M.1 )
```
